...
public class ProductServiceImpl implements IProductService {
	...
	public ResponseEntity<ProductResponseRest> save(Product product, Long categoryId) {
		...
		try {
			...
			if(productSave !=null ) {
				...
				response.setMetadata("Respuesta ok", "00", "Producto gradado");
			} else {
	...
	public ResponseEntity<ProductResponseRest> searchById(Long id) {
		...
		try {
			...
			if( product.isPresent()) {
				...
				response.getProduct().setProducts(list);
				response.setMetadata("Respesta ok", "00", "Producto encontrado");
	...
	public ResponseEntity<ProductResponseRest> searchByName(String name) {
		...
		try {
			...
			if( listAux.size()>0) {
				...
				response.getProduct().setProducts(list);
				response.setMetadata("Respesta ok", "00", "Productos encontrados");
	...
	public ResponseEntity<ProductResponseRest> deleteById(Long id) {
		...
		try {
		 ...
		 response.setMetadata("Respesta ok", "00", "Producto eliminado");
			
					
		} catch (Exception e) {
			e.getStackTrace();
			response.setMetadata("respuesta nok", "-1", "Error eliminar producto");
			return new ResponseEntity<ProductResponseRest>(response, HttpStatus.INTERNAL_SERVER_ERROR);			
		}
		return new ResponseEntity<ProductResponseRest>(response, HttpStatus.OK);
	}
